$(document).on("nifty.ready", function () {
    ...
    var n = function () {
        ...
        var n = $("#demo-nifty-settings"), s = $("#container"), d = $("#mainnav-container"), o = $("#aside-container"),
            c = $("#demo-set-btn"), l = document.getElementById("demo-box-lay"),
            h = document.getElementById("demo-box-img"), m = $("#demo-bg-boxed"),
            r = document.getElementById("demo-close-boxed-img"), f = $("#demo-blurred-bg"), u = $("#demo-polygon-bg"),
            g = $("#demo-abstract-bg");
        ...
        var v = "easeInQuart easeOutQuart easeInBack easeOutBack easeInOutBack steps jumping rubber",
            p = document.getElementById("demo-anim"), k = document.getElementById("demo-ease");
        ...
        var x = document.getElementById("demo-nav-coll"), I = document.getElementById("demo-nav-fixed"),
            B = document.getElementById("demo-nav-profile"), E = document.getElementById("demo-nav-shortcut"),
            A = document.getElementById("demo-nav-offcanvas"), w = $("#mainnav-profile"), P = $("#mainnav-shortcut");
        ...
        var N = document.getElementById("demo-asd-vis"), z = document.getElementById("demo-asd-fixed"),
            O = document.getElementById("demo-asd-float"), T = document.getElementById("demo-asd-align"),
